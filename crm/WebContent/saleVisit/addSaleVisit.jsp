...
<html>
	...
	<body>
		<form action="${pageContext.request.contextPath }/saleVisitAction_saveOrUpdate" method="post">	
			...
			<div class="inputItem">
				<label>拜访时间 ：</label>
				<input type="text" id="accessTime" autocomplete="off" name="visit_time" />
			</div>
			<div class="inputItem">
				<label>被拜访人 ：</label>
				<input type="text" name="visit_interviewee" />
			</div>
			<div class="inputItem">
				<label>拜访地址：</label>
			...
			<div class="inputItem">
				<label>	下次拜访时间：</label>
				<input type="text" id="accessTime2" autocomplete="off" name="visit_nexttime" />
			</div>
			<div class="inputItem">
